...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Wed Nov 21 14:16:00 2012
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .obj/tracer1.0.0/ && $(COPY_FILE) --parents src/Window.h src/Scene.h src/SideBar.h src/Vector3D.h src/Point3D.h src/Colour.h src/I_GenericShape.h src/Sphere.h src/Plane.h src/Triangle.h src/Ray.h src/Light.h .obj/tracer1.0.0/ && $(COPY_FILE) --parents src/main.cpp src/Window.cpp src/Scene.cpp src/SideBar.cpp src/Vector3D.cpp src/Point3D.cpp src/Colour.cpp src/I_GenericShape.cpp src/Sphere.cpp src/Plane.cpp src/Triangle.cpp src/Ray.cpp src/Light.cpp .obj/tracer1.0.0/ && $(COPY_FILE) --parents src/SideBar.ui .obj/tracer1.0.0/ && (cd `dirname .obj/tracer1.0.0` && $(TAR) tracer1.0.0.tar tracer1.0.0 && $(COMPRESS) tracer1.0.0.tar) && $(MOVE) `dirname .obj/tracer1.0.0`/tracer1.0.0.tar.gz . && $(DEL_FILE) -r .obj/tracer1.0.0
