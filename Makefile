...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Sun Nov 25 13:29:11 2012
...
SOURCES       = src/main.cpp \
		...
		src/Ray.cpp \
		src/Light.cpp \
		src/SceneGenerator.cpp .moc/moc_Window.cpp \
		.moc/moc_Scene.cpp \
		.moc/moc_SideBar.cpp
OBJECTS       = .obj/main.o \
		.obj/Window.o \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .obj/tracer1.0.0/ && $(COPY_FILE) --parents src/Window.h src/Scene.h src/SideBar.h src/Vector3D.h src/Point3D.h src/Colour.h src/I_GenericShape.h src/Sphere.h src/Plane.h src/Triangle.h src/Quad.h src/Ray.h src/Light.h src/SceneGenerator.h .obj/tracer1.0.0/ && $(COPY_FILE) --parents src/main.cpp src/Window.cpp src/Scene.cpp src/SideBar.cpp src/Vector3D.cpp src/Point3D.cpp src/Colour.cpp src/I_GenericShape.cpp src/Sphere.cpp src/Plane.cpp src/Triangle.cpp src/Quad.cpp src/Ray.cpp src/Light.cpp src/SceneGenerator.cpp .obj/tracer1.0.0/ && $(COPY_FILE) --parents src/SideBar.ui .obj/tracer1.0.0/ && (cd `dirname .obj/tracer1.0.0` && $(TAR) tracer1.0.0.tar tracer1.0.0 && $(COMPRESS) tracer1.0.0.tar) && $(MOVE) `dirname .obj/tracer1.0.0`/tracer1.0.0.tar.gz . && $(DEL_FILE) -r .obj/tracer1.0.0
...
compiler_moc_header_make_all: .moc/moc_Window.cpp .moc/moc_Scene.cpp .moc/moc_SideBar.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) .moc/moc_Window.cpp .moc/moc_Scene.cpp .moc/moc_SideBar.cpp
...
.moc/moc_Scene.cpp: src/I_GenericShape.h \
		src/Colour.h \
		src/Point3D.h \
		src/Ray.h \
		src/Vector3D.h \
		...
		src/SceneGenerator.h \
		src/Scene.h
	/opt/QtSDK/Desktop/Qt/4.8.1/gcc/bin/moc $(DEFINES) $(INCPATH) src/Scene.h -o .moc/moc_Scene.cpp
...
.obj/Scene.o: src/Scene.cpp src/Light.h \
		src/Colour.h \
		src/I_GenericShape.h \
		src/Point3D.h \
		src/Ray.h \
...
.obj/Plane.o: src/Plane.cpp src/Plane.h \
		src/I_GenericShape.h \
		src/Colour.h \
		src/Point3D.h \
		src/Ray.h \
...
.obj/Quad.o: src/Quad.cpp src/Quad.h \
		src/I_GenericShape.h \
		src/Colour.h \
		src/Point3D.h \
		src/Ray.h \
		...
		src/Triangle.h \
		src/Plane.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o .obj/Quad.o src/Quad.cpp
...
.obj/SceneGenerator.o: src/SceneGenerator.cpp src/SceneGenerator.h \
		src/Point3D.h \
		src/Colour.h \
		src/Quad.h \
		src/I_GenericShape.h \
		...
		src/Sphere.h \
		src/Light.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o .obj/SceneGenerator.o src/SceneGenerator.cpp
