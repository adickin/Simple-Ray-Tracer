...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Thu Nov 15 01:19:35 2012
...
SOURCES       = src/GLWidget.cpp \
		...
		src/Point3D.cpp \
		src/Colour.cpp \
		src/GenericShape.cpp .moc/moc_GLWidget.cpp \
		.moc/moc_Window.cpp \
		.moc/moc_SideBar.cpp \
		.moc/moc_GenericShape.cpp
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .obj/tracer1.0.0/ && $(COPY_FILE) --parents src/GLWidget.h src/Window.h src/SideBar.h src/Vector3D.h src/Point3D.h src/Colour.h src/GenericShape.h .obj/tracer1.0.0/ && $(COPY_FILE) --parents src/GLWidget.cpp src/main.cpp src/Window.cpp src/SideBar.cpp src/Vector3D.cpp src/Point3D.cpp src/Colour.cpp src/GenericShape.cpp .obj/tracer1.0.0/ && $(COPY_FILE) --parents src/SideBar.ui .obj/tracer1.0.0/ && (cd `dirname .obj/tracer1.0.0` && $(TAR) tracer1.0.0.tar tracer1.0.0 && $(COMPRESS) tracer1.0.0.tar) && $(MOVE) `dirname .obj/tracer1.0.0`/tracer1.0.0.tar.gz . && $(DEL_FILE) -r .obj/tracer1.0.0
...
compiler_moc_header_make_all: .moc/moc_GLWidget.cpp .moc/moc_Window.cpp .moc/moc_SideBar.cpp .moc/moc_GenericShape.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) .moc/moc_GLWidget.cpp .moc/moc_Window.cpp .moc/moc_SideBar.cpp .moc/moc_GenericShape.cpp
...
.moc/moc_GenericShape.cpp: src/GenericShape.h
	/opt/QtSDK/Desktop/Qt/4.8.1/gcc/bin/moc $(DEFINES) $(INCPATH) src/GenericShape.h -o .moc/moc_GenericShape.cpp
...
.obj/GenericShape.o: src/GenericShape.cpp src/GenericShape.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o .obj/GenericShape.o src/GenericShape.cpp
...
.obj/moc_GenericShape.o: .moc/moc_GenericShape.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o .obj/moc_GenericShape.o .moc/moc_GenericShape.cpp
